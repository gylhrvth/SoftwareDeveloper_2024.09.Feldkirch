...
function selectCategory(category, points) {
    ...
    const url = `QuestionMenü.html?category=${encodeURIComponent(category)}&points=${points}&question=${encodeURIComponent(randomQuestionM1)}`;
    window.location.href = url;  // Navigate to QuestionMenü.html with the parameters
}